...
const Main = () => {
    ...
    let options = {
        ...
        anchors:              ["head", "about", "experience", "LinkedCS", "ChatApp",            "FaceDetection", "Contact"], // the anchors for each sections
        ...
        <div className="container" >
            ...
            <Section>
                <Card className="card">
                    ...
                    <Card.Body>
                        <img src={FaceDetection} alt="Face Detection"/>
                    </Card.Body>
                    <Card.Footer>
            ...
            <div style={{display: 'flex', justifyContent: "space-evenly", marginTop: "45vh", overflow: "hidden", paddingBottom: "40vh"}}>
                ...
                <Popper id="hello" open={isOpen} anchorEl={document.getElementById("phone")}transition>
                    <div style={{backgroundColor: 'black', opacity: "70%", borderRadius: "25px", marginBottom: "2vh", padding: ".25rem"}}>
                        <h2 style={{color: "white"}}>208-954-3979</h2>
                    </div>
                </Popper>
                <div onClick={handlePhone} class='iconBack' id="phone" style={{ height: "10.5vh", width: "5vw", borderRadius: "50%", overflow: "hidden", border: "1px solid grey"}}>
